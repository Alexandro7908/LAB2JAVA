...
/**
 * Демонстрационный класс для работы с сущностью «Дом».
 * Реализует создание неизменяемых домов с валидацией ввода.
 */
public class Zad43 {

    /**
     * Модель дома с фиксированным количеством этажей.
     * Неизменяемость обеспечивается модификатором final и отсутствием сеттеров.
     */
